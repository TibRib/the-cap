...
class TestCreation(unittest.TestCase):
    ...
    def test_creation_full(self):
        ath1 = Athlete(name='john', birth_year=1999, sport='Curling', win=[2000, 3000], loss=[1000], draw=[1200])
...
class TestJSON(unittest.TestCase):
    ...
    def test_export_full(self):
        ath1 = Athlete(name='john', birth_year=1999, sport='Curling', win=[1600, 3000], loss=[], draw=[1000, 1000])
        created = json.loads(ath1.exportJSON())
...
class TestRanking(unittest.TestCase):
    ...
    def test_update_ranking(self):
        ...
        #classic testing
        ath3 = Athlete(rank = 1050)
        ath4 = Athlete(rank = 1032)
        #winning
